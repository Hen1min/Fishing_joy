...
public class Fish6 {
    ...
    public static final String IMAGE_PATH = "fish6.png";
    ...
    // 默认属性（可改）
    private static final String DEFAULT_NAME = "Fish6";
    private static final int DEFAULT_HP = 160;
    private static final int DEFAULT_POINTS = 270;
    private static final int DEFAULT_ENERGY = 2;
    private static final float DEFAULT_SPEED = 15f; // units per second (pixels or world units)
