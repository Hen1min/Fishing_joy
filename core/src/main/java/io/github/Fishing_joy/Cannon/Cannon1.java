...
/**
 * Level 1 cannon implementation (uses cannon1.png sprite sheet).
 */
public class Cannon1 extends Cannon {
    ...
    public Cannon1(float x, float y) {
        super(x, y);
        if (!loaded) load();
    ...
    public static void load() {
        ...
        texture = new Texture(Gdx.files.internal("cannon1.png"));
    ...
    @Override
    public void dispose() {
        // instance dispose no-op; static textures disposed via disposeStatic
    }
}
